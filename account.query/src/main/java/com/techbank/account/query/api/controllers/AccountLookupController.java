...
public class AccountLookupController {
    ...
    @GetMapping(path = "/")
    public ResponseEntity<AccountLookupResponse> queryAllAccounts(){
        try {
    ...
    public ResponseEntity<AccountLookupResponse> queryAccountById(@PathVariable(value = "id") String id){
        try {
    ...
    public ResponseEntity<AccountLookupResponse> queryAccountByHolder(@PathVariable(value = "accountHolder") String accountHolder){
        try {
    ...
    public ResponseEntity<AccountLookupResponse> queryAccountWithBalance(@PathVariable(value = "equalityType") EqualityType equalityType,
