...
public class AccountAggregate extends AggregateRoot {
    ...
    public void withdrawFunds(double amount){
        if (!this.active) {
            throw new IllegalStateException("Funds cannot be wiithdrawn from a closed account!");
        }
    ...
    public void closeAccount(){
        if (!this.active) {
            throw new IllegalStateException("he bank account has already been closed!");
        }
